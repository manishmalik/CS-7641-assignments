...
class QLearnerExperiment(BaseExperiment):
    ...
    def perform(self):
        ...
        dims = len(discount_factors) * len(self._alphas) * len(self._q_inits) * len(self._epsilons) * len(
            self._epsilon_decays)
                    ...
                    for epsilon_decay in self._epsilon_decays:
                        for discount_factor in discount_factors:
                            ...
                            stats.pickle_results(
                                os.path.join(PKL_DIR, '{}_{}_{}_{}_{}_{}_{}.pkl'.format(self._details.env_name,
                                                                                        alpha, q_init, epsilon,
                                                                                        epsilon_decay, discount_factor,
                                                                                        '{}')), map_desc.shape,
                                step_size=self._max_episodes / 20.0)
                            stats.plot_policies_on_map(
                                os.path.join(IMG_DIR, '{}_{}_{}_{}_{}_{}_{}.png'.format(self._details.env_name,
                                                                                        alpha, q_init, epsilon,
                                                                                        epsilon_decay, discount_factor,
                                                                                        '{}_{}')),
                            ...
                            episode_stats.to_csv(
                                os.path.join(QL_DIR, '{}_{}_{}_{}_{}_{}_episode.csv'.format(self._details.env_name,
                                                                                            alpha, q_init, epsilon,
                                                                                            epsilon_decay,
                                                                                            discount_factor)))
                            ...
                            optimal_policy_stats.to_csv(
                                os.path.join(QL_DIR, '{}_{}_{}_{}_{}_{}_optimal.csv'.format(self._details.env_name,
                                                                                            alpha, q_init, epsilon,
                                                                                            epsilon_decay,
                                                                                            discount_factor)))
